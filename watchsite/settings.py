...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Add any other static directories here
]
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Adjust this based on your project structure
# settings.py
